...
const BannerInfo = ({info}) => {
    return (
        <div>
            ...
            <button className='px-8 py-3 bg-blue-600 rounded-full uppercase text-sm text-white cursor-pointer hover:bg-blue-900 hover:shadow-lg duration-300'>{info.btnText}</button>
        </div>
    );
};
