...
const ContactForm = () => {
    ...
    return (
        <div>
            ...
            {
                inputs.map(i=><input key={i.id} className='w-full border-b h-10 border-black mt-5 focus:outline-none' type={i.type} name={i.name} id="" placeholder={i.name}/>)
            }
            <textarea className='w-full border-b h-20 border-black mt-4 focus:outline-none' name="" id="" placeholder='Message'></textarea>
